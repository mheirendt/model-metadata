...
/**
 * **Check to see if the value on the left is *greater than or equal to* the value on the right**<br />
 ...
 * const operator = OperatorMap.get('gte');
 * 
 ...
 */
@injectable()
export class GreaterThanOrEqual extends OperatorBase {
